    ...
    return (
        <>
            <section className="mt-20 lg:mt-20 w-full h-full">
                ...
                <Carousel className="rounded-xl" autoplay={true} loop={true} autoplayDelay={5000} navigation={({ setActiveIndex, activeIndex, length }) => (
                    ...
                    <div className="banner relative">
                            <a href="">
                                <img className="h-full w-full object-cover rounded-3xl" src="img/banners/mainBanner.webp" />
                    ...
                    <div className="banner relative">
                        <a href="">
                            <img className="h-full w-full object-cover rounded-3xl" src="img/banners/mainBannerVampire.jpg" />
                    ...
                    <div className="banner relative">
                        <a href="">
                            <img className="h-full w-full object-cover rounded-3xl" src="img/banners/mainBanner2.jpg" />
