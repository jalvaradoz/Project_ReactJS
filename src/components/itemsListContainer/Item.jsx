...
const Item = ({src1, src2, title, price, details, stock}) => {
    ...
    return (
        <div>
            ...
            {
                showDetails && <ItemDetailContainer img={src1} img2={src2} details={details} price={price} title={title} stock={stock} toggleView={toggleDetails} />
            }
        </div>
    )
}
