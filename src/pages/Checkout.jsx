...
const Checkout = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Alter Jewelry | Check-out</title>
                <meta name='description' content='Check out process for your cart. Explore the history of our company and how it became what it is today. Each piece is meticulously handcrafted with vegan and eco-friendly materials. Dive into our universe of unique and sustainable design where beauty meets ethics. Welcome to a world where distinction is eco-friendly!'/>
            </Helmet>
            <motion.div
