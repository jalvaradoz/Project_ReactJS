            ...
            >
                <div className="my-20">
                    ...
                    <div className='relative'>
                        ...
                        <h2 className='w-fit text-nowrap text-3xl md:text-6xl lg:text-7xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-40 title bg-[#00000077] pb-2 px-4 rounded-3xl'>Alter Jewelry</h2>
                    </div>
                    ...
                    <div className='relative'>
                        ...
                        <h2 className='w-fit text-nowrap text-3xl md:text-6xl lg:text-7xl absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-40 title bg-[#00000077] pb-2 px-4 rounded-3xl'>Florent story</h2>
                    </div>
                    <div className='mx-auto p-10 bg-[--black-300] dark:bg-[--black-500] rounded-3xl w-[95%]'>
